...
export class ReviewService {
    ...
    public async getReviewsByCafeId(getReviewsByCafeIdDTO: GetReviewsByCafeIdDTO): Promise<Review[]> {
    ...
    public async getReviewsByUploaderId(getReviewsByUploaderIdDTO: GetReviewsByUploaderIdDTO): Promise<Review[]> {
